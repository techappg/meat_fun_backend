...
class UserService(object):
    ...
    def update(user_id, **fields):
        ...
        user_profile.profile_image = fields.get('profile_image', user_profile.profile_image if user_profile.profile_image else "profile/avatar.jpg")
        user_profile.save()
